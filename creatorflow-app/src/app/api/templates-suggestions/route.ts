...
// Cached template suggestions function
const cachedGetTemplateSuggestions = cacheUtils.cache(async (userId: string, platform: string | null, category: string | null, recent: boolean) => {
...
export async function GET(req: NextRequest) {
  ...
  const templates = await cachedGetTemplateSuggestions(userId, platform, category, recent);
