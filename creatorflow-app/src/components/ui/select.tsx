  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      onOpenAutoFocus={(e) => {
        ...
        e.preventDefault();
        // Find the first focusable element within the select content
      ...
      onCloseAutoFocus={(e) => {
        ...
        const trigger = document.querySelector('[data-radix-select-trigger][data-state="open"]') as HTMLElement;
        if (trigger) {
          trigger.focus();
        }
      }}
      onEscapeKeyDown={(e) => {
        // Allow escape key to close select
        e.preventDefault();
        const trigger = document.querySelector('[data-radix-select-trigger][data-state="open"]') as HTMLElement;
        if (trigger) {
          trigger.click();
